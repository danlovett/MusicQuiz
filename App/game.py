...
class Game():
    ...
    def UIdata(self):
        ...
        if q == sys_genre:
            ...
            input(f'Okay, running {sys_genre} music now.\nPress ENTER to continue.'), t.sleep(0.5), os.system('cls' if os.name=='nt' else 'clear'), Music().UIdata()
        else: os.system('cls' if os.name=='nt' else 'clear'), print(f'"{q}" is not a music genre avaliable for this quiz.\nRestart the program and try again.')
    ...
    def attempt(self):
        global u_attempt
        u_attempt += 1
        if u_attempt == 3: print("Attempts exceeded. Try again later."), exit()
...
class Music:
    ...
    def UIdata(self):
        ...
        while bt == False:
            ...
            elif q_u == 'Exit': bt = True, print(f'Thanks for playing {userName}!')
